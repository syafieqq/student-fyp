...
<body>
  <section class="fnavbar">
    ...
    <style>
      ...
      ?>< !DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><title>Eja</title><meta name="viewport"content="width=device-width, initial-scale=1.0"/>< !-- <meta http-equiv="refresh"content="1">--><link rel="stylesheet"href="https://cdnjs.cloudflare.com/ajax/libs/materialize/1.0.0/css/materialize.min.css"></head><body><style>
    </style>
      ...
      <nav>
        <div class="nav-wrapper">
          ...
          <ul class="right hide-on-med-and-down">
            ...
            <li><a href="indexxafterlogin.php"><span class="hvr-grow"></span>
                <div><img src="house.svg" alt="https://www.flaticon.com/authors/freepik" width="30px" height="30px">

            <li><a href="index.php"><span class="hvr-grow"></span>
                <div><img src="fried-chicken.svg" alt="https://www.flaticon.com/authors/freepik" width="30px" height="30px">
            ...
            <li><a href="cart.php"><span class="hvr-grow"></span>
                <div><img src="images/cartt.svg" alt="https://www.flaticon.com/authors/freepik" width="30px" height="30px"><?php
            ...
            <li><a href="contactus.php"><span class="hvr-grow"></span>
  ...
  <center>
    <p>
      <font face="courier" font size="7" color="darkgray">
        About Us
      </font>
    </p>
  </center>
  ...
  <center>
    <p>
      <font face="courier" font size="4" color="black">
  ...
  <body>
    ...
    <div id="map-container-google-1" style="height: 500px">
      <iframe src="https://maps.google.com/maps?q=uncle jack kuala terengganu&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" style="  width: 100%;
    height: 500px;
    border-radius: 0px;
    ...
    <div class="img-container">
      <img src="klkl.webp" alt="Simply Easy Learning" width="700" height="200">
  </body>
