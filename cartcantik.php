      ...
      <nav>
        <div class="nav-wrapper">
          ...
          <ul class="right hide-on-med-and-down">
            ...
            <li><a href="cart.php" class="hvr-grow">
                <div><img src="images/cart.svg" alt="https://www.flaticon.com/authors/freepik" width="30px" height="30px"></div>
              </a></li>
        ...
        <tbody>
              ...
              <td>
                <form method='post' action=''>
                  ...
                  <select name='quantity' class='quantity' onChange="this.form.submit()">
                    <option <?php if ($product["quantity"] == 1) echo "selected"; ?> value="0">Select
                    </option>
          ...
          <tr>
            <td colspan="6" align="right">
              <strong>
                <center>TOTAL: <?php echo "RM " . $total_price; ?>
              </strong>
            </td>
          </tr>
        </tbody>
...
<body>
  ...
  <b>
    <li><a href="aboutus.php" class="hvr-groww">MAKE ORDER</a></li>
  </b>
  ...
  <b>
    <li><a href="aboutus.php" class="hvr-growww">Add more food</a></li>
  </b>
  <style>
    .hvr-growww {
      width: 100%;
