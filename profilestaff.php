				...
				<form method="post" enctype="multipart/form-data">
					...
					<div  class="form-group">
                     <label for="name">First Name</label>
                      <input type="text" id="name" value="<?php if(isset($firstnames)){ echo $firstnames;}?>" class="form-control" name="name" required="required"/>
                    </div>
					...
					<div class="form-group">
                      ...
                      <input type="text" id="mob" value="<?php if(isset($mobiles)){ echo $mobiles;}?>" class="form-control" name="mob" required="required"/>
                    </div>
