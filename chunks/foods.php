			...
			<div class="col s12 m4">
				<div class="card">
			        ...
			        <div class="card-content center">
			          <a href="backends/order-food.php?id=<?php echo $arr_all[$i+$j-2]['id']; ?>" style="background: #ff0000;" class="btn waves-effect waves-block waves-light" href="">Order Now!</a>
			        </div>
				    </div>
				    <div class="card-reveal">
				      ...
				      <p><?php echo $arr_all[$i+$j-2]['description']; ?></p>
						 <p><?php echo $arr_all[$i+$j-2]['price']; ?></p>
				    </div>
